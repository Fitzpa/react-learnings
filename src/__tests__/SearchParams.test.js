...
// aftereach is a function that Jest gives us.
afterEach(cleanup);

test("SearchParams", async () => {
  // getByTestId is a function give to us from testing-library/react's render function
  const { container, getByTestId, getByText } = render(<SearchParams />);

  const animalDropdown = getByTestId("use-dropdown-animal");
  // The plus one accounts for the 'all' option in the dropdown
